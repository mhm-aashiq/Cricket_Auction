...
namespace Cricket_Auction.Migrations
{
    ...
    [Migration("20221009073411_AddToDBTrophy")]
    partial class AddToDBTrophy
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cricket_Auction.Models.Team", b =>
                {
                    b.HasOne("Cricket_Auction.Models.Player", "Players")
                        .WithMany()
                        .HasForeignKey("PlayerID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Cricket_Auction.Models.TeamOwner", "TeamOwners")
                        .WithMany()
